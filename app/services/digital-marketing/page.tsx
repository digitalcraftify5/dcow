...
export default function DigitalMarketingPage() {
  ...
  const CAPABILITIES = [
    {
      num: "01",
      title: "Data-Driven PPC & Paid Ads",
      desc: "High-ROI Google Ads, Meta Ads, and LinkedIn campaigns engineered for hyper-targeted audience acquisition.",
      icon: DollarSign,
      color: "text-cyan-400",
    ...
    {
      num: "02",
      title: "Social Media Brand Dominance",
      desc: "Multi-platform visual content strategy, reel production, and community engagement for maximum brand presence.",
      icon: Globe,
    ...
    },
    {
      ...
      desc: "Continuous A/B multivariate landing page testing that turns incoming ad traffic into paid customers.",
      icon: Target,
    ...
    {
      num: "04",
      title: "Automated Email & SMS Funnels",
      desc: "Klaviyo and Mailchimp automated lifecycle workflows driving high customer LTV and repeat purchases.",
      icon: Zap,
      color: "text-teal-400",
    ...
    },
    {
      ...
      desc: "Custom GA4 multi-touch attribution dashboards giving 100% clarity on customer acquisition cost (CAC).",
      icon: BarChart3,
    ...
    {
      num: "06",
      title: "Omnichannel Brand Growth Strategy",
      desc: "Holistic marketing campaigns aligning paid ads, organic content, influencer outreach, and PR.",
      icon: TrendingUp,
      color: "text-pink-400",
    ...
    <main className="relative min-h-screen bg-zinc-950 text-white overflow-hidden selection:bg-cyan-500 selection:text-zinc-950">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-8 text-left">
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <CyberBadge text="SOVEREIGN_SERVICE // DIGITAL_MARKETING" variant="cyan" />
            </motion.div>
            ...
            >
              Scale Revenue With High-ROI, <br />
              <span className="text-gradient-teal-cyan">Precision Digital Marketing</span> <br />
              Campaigns.
            </motion.h1>
            ...
            >
              We run data-backed performance advertising, CRO landing page optimization, and omnichannel growth funnels designed to deliver predictable, profitable client acquisition.
            </motion.p>
      ...
      <section className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-zinc-800/80">
        <div className="text-center space-y-4 mb-16">
          <CyberBadge text="MARKETING_SPECS // GROWTH_ENGINE" variant="teal" />
          <h2 className="text-3xl sm:text-5xl font-black tracking-tight text-white">
            Data-Driven Strategies for <span className="text-gradient-teal-cyan">Maximum ROI</span>
          </h2>
        </div>
      ...
      <section className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto text-center space-y-8">
        <div className="glass-card p-10 sm:p-14 rounded-3xl border border-cyan-500/40 bg-zinc-950/90 shadow-[0_0_60px_rgba(0,240,255,0.2)] space-y-6">
          <CyberBadge text="SCALE_REVENUE // PERFORMANCE_ADS" variant="cyan" />
          <h2 className="text-3xl sm:text-5xl font-black tracking-tight text-white">
            Ready to Scale Your <span className="text-gradient-teal-cyan">Marketing ROI</span>?
          </h2>
