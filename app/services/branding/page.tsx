...
export default function BrandingPage() {
  ...
  const CAPABILITIES = [
    {
      num: "01",
      title: "Sovereign Brand Strategy & Positioning",
      desc: "Defining market positioning, core messaging, brand voice, and value propositions that command industry leadership.",
      icon: Award,
      color: "text-cyan-400",
    ...
    {
      num: "02",
      title: "Bespoke Visual Identity Systems",
      desc: "Creating vector logos, custom color tokens, typography scales, and brand identity guidelines.",
      icon: Palette,
    ...
    {
      num: "03",
      title: "3D Cyber Motion Brand Assets",
      desc: "Animated logo stings, 3D brand visuals, and digital video assets engineered for high-impact social and web presence.",
      icon: Layers,
    ...
    {
      num: "04",
      title: "Corporate Identity & Collateral Design",
      desc: "Business cards, pitch decks, stationery, social media kits, and corporate presentation templates.",
      icon: Globe,
      color: "text-teal-400",
    ...
    {
      num: "05",
      title: "Brand Voice & Content Style Guides",
      desc: "Establishing tone of voice, copy guidelines, and brand storytelling rules for consistent messaging across channels.",
      icon: Eye,
    ...
    {
      num: "06",
      title: "Comprehensive Brand Books & Specs",
      desc: "Complete digital brand guidelines delivered as interactive PDF and web documentation for internal teams.",
      icon: ArrowRight,
      color: "text-pink-400",
    ...
    <main className="relative min-h-screen bg-zinc-950 text-white overflow-hidden selection:bg-cyan-500 selection:text-zinc-950">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-8 text-left">
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <CyberBadge text="SOVEREIGN_SERVICE // BRANDING_IDENTITY" variant="cyan" />
            </motion.div>
            ...
            >
              Crafting Iconic, <br />
              <span className="text-gradient-teal-cyan">Luxury Cyber Brand</span> <br />
              Identities.
            </motion.h1>
            ...
            >
              We define, design, and deploy high-ticket brand identities that resonate with premium audiences and establish sovereign market leadership.
            </motion.p>
      ...
      <section className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-zinc-800/80">
        <div className="text-center space-y-4 mb-16">
          <CyberBadge text="BRANDING_SPECS // VISUAL_SYSTEMS" variant="teal" />
          <h2 className="text-3xl sm:text-5xl font-black tracking-tight text-white">
            Transforming Vision Into <span className="text-gradient-teal-cyan">Unforgettable Brands</span>
          </h2>
        </div>
      ...
      <section className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto text-center space-y-8">
        <div className="glass-card p-10 sm:p-14 rounded-3xl border border-cyan-500/40 bg-zinc-950/90 shadow-[0_0_60px_rgba(0,240,255,0.2)] space-y-6">
          <CyberBadge text="ELEVATE_BRAND // SOVEREIGN" variant="cyan" />
          <h2 className="text-3xl sm:text-5xl font-black tracking-tight text-white">
            Ready to Build Your <span className="text-gradient-teal-cyan">Brand Identity</span>?
          </h2>
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            <Button
              ...
              className="font-bold shadow-[0_0_30px_rgba(0,240,255,0.5)]"
            >
              Request Brand Strategy Session
            </Button>
          </div>
        </div>
      </section>
