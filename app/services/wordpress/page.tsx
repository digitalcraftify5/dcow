  ...
  const CAPABILITIES = [
    {
      ...
      desc: "Combining WordPress CMS backend content management with sub-second Next.js React frontend speed.",
      icon: Globe,
      color: "text-cyan-400",
    ...
    {
      num: "02",
      title: "Bespoke Gutenberg & ACF Block Development",
      desc: "Custom lightweight WordPress Gutenberg blocks tailored specifically to your content publishing needs without bloated plugins.",
      icon: Code,
    ...
    },
    {
      ...
      desc: "Custom WooCommerce checkout flows, payment gateway integrations, and inventory synchronization.",
      icon: Layers,
    ...
    {
      num: "04",
      title: "PageSpeed & Object Cache Optimization",
      desc: "Redis object caching, Cloudflare APO integration, and image WebP pipelines for 95+ PageSpeed scores.",
      icon: Zap,
      color: "text-teal-400",
    ...
    {
      num: "05",
      title: "Hardened WordPress Security Protocols",
      desc: "Custom login URLs, 2FA enforcement, database prefix obfuscation, and automated malware scanning.",
      icon: ShieldCheck,
    ...
    },
    {
      ...
      desc: "Seamless server migration, database cleanup, and 301 URL redirect mapping with 0 traffic loss.",
      icon: ChevronRight,
      color: "text-pink-400",
    ...
    <main className="relative min-h-screen bg-zinc-950 text-white overflow-hidden selection:bg-cyan-500 selection:text-zinc-950">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-8 text-left">
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <CyberBadge text="SOVEREIGN_SERVICE // HEADLESS_WORDPRESS" variant="cyan" />
            </motion.div>
            ...
            >
              Custom Headless & <br />
              <span className="text-gradient-teal-cyan">High-Speed WordPress</span> <br />
              Engineering.
            </motion.h1>
            ...
            >
              We engineer custom WordPress platforms, headless Next.js frontends, and tailored WooCommerce stores built for sub-second page loads, zero bloat, and enterprise security.
            </motion.p>
      ...
      <section className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-zinc-800/80">
        <div className="text-center space-y-4 mb-16">
          <CyberBadge text="WORDPRESS_SPECS // HEADLESS_TECH" variant="teal" />
          <h2 className="text-3xl sm:text-5xl font-black tracking-tight text-white">
            Custom Gutenberg & Headless <span className="text-gradient-teal-cyan">Architecture</span>
          </h2>
        </div>
      ...
      <section className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto text-center space-y-8">
        <div className="glass-card p-10 sm:p-14 rounded-3xl border border-cyan-500/40 bg-zinc-950/90 shadow-[0_0_60px_rgba(0,240,255,0.2)] space-y-6">
          <CyberBadge text="WORDPRESS_SOLUTIONS // HEADLESS" variant="cyan" />
          <h2 className="text-3xl sm:text-5xl font-black tracking-tight text-white">
            Ready to Build a Fast <span className="text-gradient-teal-cyan">WordPress Platform</span>?
          </h2>
