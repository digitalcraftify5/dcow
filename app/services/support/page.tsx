...
export default function SupportPage() {
  ...
  const CAPABILITIES = [
    {
      num: "01",
      title: "24/7 Dedicated Senior Engineering Helpdesk",
      desc: "Direct access to senior fullstack engineers via dedicated Slack, Teams, or ticket dispatch.",
      icon: Headphones,
      color: "text-cyan-400",
    ...
    {
      num: "02",
      title: "15-Minute Critical Incident SLA",
      desc: "Guaranteed 15-minute response time for critical production downtime or security threats.",
      icon: Clock,
    ...
    {
      num: "03",
      title: "Emergency Bug Triage & Hotfixes",
      desc: "Immediate hotfix deployments for unexpected frontend bugs, API breakages, or gateway issues.",
      icon: Zap,
    ...
    {
      num: "04",
      title: "Server & CDN Telemetry Audits",
      desc: "Proactive server metric monitoring, SSL certificate verification, and memory usage profiling.",
      icon: ShieldCheck,
      color: "text-teal-400",
    ...
    {
      num: "05",
      title: "Monthly Technical Consultation & Advisory",
      desc: "Dedicated monthly architecture reviews to plan upcoming feature additions and tech stack upgrades.",
      icon: ArrowRight,
    ...
    {
      num: "06",
      title: "Full Infrastructure & DNS Support",
      desc: "Domain management, DNS record configuration, email server setup, and SSL renewal management.",
      icon: ChevronRight,
      color: "text-pink-400",
    ...
    <main className="relative min-h-screen bg-zinc-950 text-white overflow-hidden selection:bg-cyan-500 selection:text-zinc-950">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-8 text-left">
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <CyberBadge text="SOVEREIGN_SERVICE // DEDICATED_ENGINEERING_SUPPORT" variant="cyan" />
            </motion.div>
            ...
            >
              24/7 Dedicated Senior <br />
              <span className="text-gradient-teal-cyan">Engineering & Infrastructure</span> <br />
              Support.
            </motion.h1>
            ...
            >
              We provide round-the-clock technical support, rapid emergency hotfix deployments, and dedicated senior developer assistance for your web applications.
            </motion.p>
      ...
      <section className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-zinc-800/80">
        <div className="text-center space-y-4 mb-16">
          <CyberBadge text="SUPPORT_SPECS // SLA_PROTECTION" variant="teal" />
          <h2 className="text-3xl sm:text-5xl font-black tracking-tight text-white">
            Dedicated Engineering Support <span className="text-gradient-teal-cyan">When You Need It Most</span>
          </h2>
        </div>
      ...
      <section className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto text-center space-y-8">
        <div className="glass-card p-10 sm:p-14 rounded-3xl border border-cyan-500/40 bg-zinc-950/90 shadow-[0_0_60px_rgba(0,240,255,0.2)] space-y-6">
          <CyberBadge text="GET_ENGINEERING_SUPPORT // SLA" variant="cyan" />
          <h2 className="text-3xl sm:text-5xl font-black tracking-tight text-white">
            Need 24/7 Dedicated <span className="text-gradient-teal-cyan">Developer Assistance</span>?
          </h2>
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            <Button
              ...
              className="font-bold shadow-[0_0_30px_rgba(0,240,255,0.5)]"
            >
              Get Dedicated Support Proposal
            </Button>
          </div>
        </div>
      </section>
