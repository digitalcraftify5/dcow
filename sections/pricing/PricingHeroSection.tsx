...
import { ArrowRight, Globe, ShieldCheck, Terminal, Zap, CheckCircle2 } from "lucide-react";
...
export const PricingHeroSection: React.FC = () => {
  return (
    <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden py-20 lg:py-24">
      ...
      <div className="absolute bottom-10 right-10 h-[350px] w-[350px] rounded-full bg-emerald-500/12 blur-[140px] pointer-events-none" />

      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-10">
        <div className="flex flex-col items-center text-center space-y-6 max-w-4xl mx-auto">
          {/* Line 1 Cyber Badge Tag */}
          <CyberBadge text="PRICING_PLANS // TRANSPARENT_TIERS" variant="cyan" />

          {/* Main Headline */}
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-white leading-[1.15]">
            Transparent <span className="text-gradient-teal-cyan">Enterprise Web Architecture</span> Investment.
          </h1>
          ...
          <div className="p-4 rounded-2xl glass-card border border-cyan-500/30 bg-zinc-950/80 shadow-[0_0_30px_rgba(0,240,255,0.15)] max-w-2xl text-left">
            ...
            <p className="text-xs sm:text-sm text-zinc-300 leading-relaxed font-sans">
              Choose the ideal digital architecture tier for your enterprise. Scale effortlessly with high-speed Edge CDN hosting, custom React & Flutter engineering, 24/7 SLA uptime, and zero-trust security.
            </p>
          </div>
